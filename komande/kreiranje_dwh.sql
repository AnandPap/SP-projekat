...
INSERT INTO ORDER_FACT (ORDER_ID, ITEM_ID, DIM_EMPLOYEE_FK, DIM_CUSTOMER_FK, DIM_PRODUCT_FK, ORDER_DATE_FK, STATUS, QUANTITY)
SELECT o.ORDER_ID, oi.ITEM_ID, o.SALESMAN_ID, dc.DIM_CUSTOMER_ID, dp.DIM_PRODUCT_ID, dt.ORDER_DATE_ID, o.STATUS, oi.QUANTITY
FROM prod.ORDERS o
